    ...
    <div class="container-fluid px-4">
        <div class="row mt-4">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <h1>{{ $total_user }}</h1> Customer
                    </div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small link-dark stretched-link" href="{{ route('admin.user') }}">Kelola Customer</a>
                        <div class="small"><i class="fas fa-angle-right"></i></div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <h1>{{ $total_alat }}</h1> Produk
                    </div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small link-dark stretched-link" href="{{ route('alat.index') }}">Kelola Produk</a>
                        <div class="small"><i class="fas fa-angle-right"></i></div>
                    </div>
                </div>
            </div>
