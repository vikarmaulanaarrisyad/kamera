...
<div class="container">
    <div class="card">
        ...
        <div class="card-body" style="overflow: auto">
            @if ($paymentStatus == 3)
                <div class="alert alert-success">Silakan melakukan melaksanakan sesi foto pada tanggal yang tertera</div>
            @endif
            <b>Tanggal Booking :</b> {{ date('d M Y H:i', strtotime($detail->first()->starts)) }} <br>
            ...
            @if ($paymentStatus == 2)
                <div class="alert {{ ($detail->first()->payment->bukti == NULL) ? 'alert-primary' : 'alert-success'}}">
                    @if ($detail->first()->payment->bukti == NULL)
                        ...
                        <h4><b>BSI 7174348302</b></h5>
                        <h6><b>a.n MOHAMMAD RIZKY WIBOWO</b></h6>
