            ...
            <div class="container-fluid">
                ...
                <div class="d-flex text-light ">
                    <div class="nav-item dropdown ">
                        <a class="link-light dropdown-toggle" style="margin-right: 100px" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                          {{ Auth::user()->name }}
                        </a>
                        <ul class="dropdown-menu dropdown-menu-right dropdown-menu-lg" aria-labelledby="navbarDropdownMenuLink">
                          <li class="text-nowrap"><a class="dropdown-item" href="{{ route('akun.pengaturan') }}">Akun</a></li>
                          <li class="text-nowrap"><a class="dropdown-item" href="{{ route('logout') }}">Logout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
