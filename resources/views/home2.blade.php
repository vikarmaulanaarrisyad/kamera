    ...
    <body>
        ...
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 mx-auto my-3">
                <h1 class="display-4 fw-normal">Lensyou Fotografi</h1>
                <p class="fw-normal">Cek Ketersediaan - Reservasi - Bayar - Selesai</p>
                @if (!Auth::check())
                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#loginModal">Login / Daftar</button>
                @endif
                <br>
                <br>
                 <p class="fw-normal">Penasaran? Cek Portofolio Kami Dulu yuk.. </p>
                 <a href="{{route('portofolio')}}" type="button"  class="btn btn-outline-success">Portofolio</a>
            </div>
        </div>
        <div class="container">
            {{-- Feebacks --}}
            ...
            <div class="row mx-3">
                ...
                <form action="">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" width="25%" placeholder="Cari" name="search" {{ (request()->get('search') != null) ? "value = ".request()->get('search')."" : "" }}>
                ...
                <div class="row row-cols-1 row-cols-sm-3 row-cols-lg-3 g-2 mb-5 mx-3">
