    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            <div class="container px-4">
                <a class="navbar-brand" href="/">Lensyou Fotografi</a>
                                    ...
                                    <div class="col">
                                        <div class="card h-100">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">@money($alat->paket4)<span class="badge bg-light text-dark" style="float: right;">24 Jam</span></li>
                                                <li class="list-group-item">@money($alat->paket3)<span class="badge bg-light text-dark" style="float: right;">12 Jam</span></li>
                                                <li class="list-group-item">@money($alat->paket2)<span class="badge bg-light text-dark" style="float: right;">6 Jam</span></li>
                                                <li class="list-group-item">@money($alat->paket1)<span class="badge bg-light text-dark" style="float: right;">6 Jam</span></li>
                                            </ul>
        ...
        <footer class="py-5 bg-dark">
            <div class="container px-4"><p class="m-0 text-center text-white">&copy; {{date('Y')}} Lensyou Fotografi</p></div>
        </footer>
        <!-- Bootstrap core JS-->
